...
test1 = default_conjugator.conjugate("manger").conjug_info['Indicatif']
test2 = default_conjugator.conjugate("partir").conjug_info['Indicatif']
test3 = default_conjugator.conjugate("facebooker").conjug_info['Indicatif']
test4 = default_conjugator.conjugate("astigratir").conjug_info['Indicatif']
test5 = default_conjugator.conjugate("mythoner").conjug_info['Indicatif']
print(test1)
print(test2)
print(test3)
print(test4)
...
test1 = conjugator.conjugate("manger").conjug_info['Indicatif']
test2 = conjugator.conjugate("partir").conjug_info['Indicatif']
test3 = conjugator.conjugate("facebooker").conjug_info['Indicatif']
test4 = conjugator.conjugate("astigratir").conjug_info['Indicatif']
test5 = conjugator.conjugate("mythoner").conjug_info['Indicatif']
print(test1)
print(test2)
print(test3)
print(test4)
